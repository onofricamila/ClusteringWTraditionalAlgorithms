...
def hdbscan(X, min_cluster_size=5, min_samples=None, alpha=1.0,
    ...
    algorithm : string, optional (default='best')
        Exactly which algorithm to use; DBCV has variants specialised
...
class HDBSCAN(BaseEstimator, ClusterMixin):
    ...
    **kwargs : optional
    ...
    prediction_data_ : PredictionData object
        ...
        ``DBCV.prediction`` (see
        :func:`~DBCV.prediction.approximate_predict`,
        :func:`~DBCV.prediction.membership_vector`,
        and :func:`~DBCV.prediction.all_points_membership_vectors`).
    ...
    def generate_prediction_data(self):
        ...
        you are intending to use functions from ``DBCV.prediction``.
        """
